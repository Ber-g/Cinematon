-- Kioskoscope — données de démo (facultatif). Reflète le mock du dashboard.
...
insert into public.booths (organization_id, label, location, address, health, software_version, indicators) values
  ('00000000-0000-0000-0000-0000000000a1', 'Kioskoscope — Le Perchoir', 'Paris 11e', 'Paris 11e · Bar Le Perchoir', 'operational', '0.2.0', '{powered,in_use}'),
  ('00000000-0000-0000-0000-0000000000a2', 'Kioskoscope — Comptoir Général', 'Paris 10e', 'Paris 10e · Le Comptoir Général', 'attention', '0.2.0', '{powered}'),
  ('00000000-0000-0000-0000-0000000000a3', 'Kioskoscope — La Commune', 'Lyon 7e', 'Lyon 7e · La Commune', 'error', '0.1.9', '{powered}'),
  ('00000000-0000-0000-0000-0000000000a4', 'Kioskoscope — La Cantine', 'Nantes', 'Nantes · La Cantine du Voyage', 'operational', '0.2.0', '{powered}');
