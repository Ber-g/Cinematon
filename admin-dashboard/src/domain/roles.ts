...
// - contenu (médias) & cabines : super_user + manager (can_write_org)
...
export const ROLE_HINTS: Record<OrgRole, string> = {
  ...
  manager: "Gère le contenu et les cabines, pas les membres ni la facturation.",
...
export const PERMISSION_MATRIX: readonly Permission[] = [
  ...
  { label: "Gérer les cabines", roles: { super_user: true, manager: true, operator: false, viewer: false } },
